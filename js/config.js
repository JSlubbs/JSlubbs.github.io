			...
			// Settings
				settings: {
					...
					// Desktop only
						...
						itemHeight:			416,		// Height (in px) of items
						itemWidth:			400,		// Default width (in px) of width
						marginBottom:		40,			// Margin (in px) to preserve at the bottom of the viewport
						marginTop:			40,			// Margin (in px) to preserve at the top of the viewport
						maxRows:			3,			// Maximum number of rows
						minRows:			1,			// Minimum number of rows
						padding:			0,			// Padding (in px) between items (0 = no padding)
